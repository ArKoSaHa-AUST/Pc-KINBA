        ...
        >
          <div className="flex items-center gap-1.5 sm:gap-2 p-2 rounded-2xl bg-glass backdrop-blur-2xl border border-border shadow-[0_10px_35px_rgba(0,0,0,0.2)] text-text-primary">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-fill-subtle hover:bg-fill-muted text-text-secondary hover:text-text-primary transition-all cursor-pointer"
              title="Swap Slots"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-purple/15 hover:bg-purple/25 text-purple border border-purple/30 transition-all cursor-pointer"
              title="AI Verdict"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-accent/20 hover:bg-accent/30 text-accent border border-accent/40 transition-all cursor-pointer"
